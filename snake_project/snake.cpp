...
//@author 20191622양진우, 20191595박승현, 20191553 권순호(40 : 30 : 30)
void Snake::init(){
    /** remove cursor**/
    curs_set(0);
    starttime = time(NULL);
...
//@author 20191622 양진우, 20191595 박승현 ( 20 : 80 )
void Snake::timer(){
    int end = time(NULL);
    Time = end - starttime;
    if(end - growthTime >= 5)
...
//@author 20191622 양진우, 20191595 박승현 (90 : 10)
...
//@author 20191622 양진우 , 20191595 박승현(80 : 20)
